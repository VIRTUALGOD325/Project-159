AFRAME.registerComponent("info-banner", {
    ...
    createBanner: function () {
      postersInfo = {
        ...
        archie: {
          banner_url: "./assets/posters/archie.jpg",
          title: "archie",
          released_year: "1942",
          description:
            "Archie Comics is a comic book from the Golden Age of Comics, which briliantly depicts the high school life of kids in 2000s and also describes the mishaps and fun times which occured.",
        },
        batman: {
          ...
          released_year: "1952",
          description:
            "This is one of all time favourites of DC universe which is adapted in to movies and different animations to depict and potray the amazing action scenes of the Comics.",
        },
      };
